...
La motivación de este documento es mostrar algunas formas simples de visualizar datos georeferenciados y alguna variable de interés en el espacio, lo que generalmente en nuestro departamento es común, ploteando datos como captura, esfuerzo, CPUE, long medias, etc. Por otro lado, aquí también podremos evaluar la distribución de nuestras variables en una escala temporal, ya sea en días, meses y/o años.

En terminos de estética de mapas, esta es tan diversa como personas en el mundo, por lo que es muy probable, esta guía no cumpla a cabalidad el gusto, pero cada uno puede luego customizar a su gusto el code. El objetivo es poder visualizar de forma rapida y simple datos en el espacio, ya que eso nos puede dar algunas señales de como es la dínamica de poblaciones del recurso que estamos analizando (bueno, no soy quien para enseñar esas cosas). 

La idea es aprovechar R y todas sus propiedades gráficas, que gracias a las nuevas librerias, ha competido de buena forma con el reinado (hasta ahora) de otras plataformas GIS; como ArcMap, Surfer, Matlab,etc., R ahora (por lo poco que conozco) cuenta con prestaciones cartográficas múltiples y suficiente (útil) resolución. 
